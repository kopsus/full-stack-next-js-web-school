...
export const columns: ColumnDef<AssignmentWithDetails>[] = [
  {
    accessorKey: "title",
    header: () => <div className="truncate">Judul Tugas</div>,
    cell: ({ row }) => (
  ...
  },
  {
    ...
    header: () => <div className="truncate">Tanggal Mulai</div>,
    cell: ({ row }) => (
      <div className="flex flex-col min-w-0">
  ...
  {
    accessorKey: "dueDate",
    header: () => <div className="truncate">Tanggal Jatuh Tempo</div>,
    cell: ({ row }) => (
      <div className="flex flex-col min-w-0">
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-44">
          ...
          {(row.original.roleLogin === "ADMIN" ||
            ...
            <>
              <ButtonEditAssignment
                allSubjects={row.original.allSubjects}
                allLessons={row.original.allLessons}
                allClasses={row.original.allClasses}
...
const ButtonViewAssignment = ({ data }: { data: AssignmentWithDetails }) => {
  ...
  const studentResult =
    data.roleLogin === "STUDENT"
      ? data.results?.find(
          (r) => r.studentId === data.lesson.class.students[0].id
        )?.answer
      : null;
            ...
            <div className="mt-4 space-y-4 text-left">
...

              {
                <>
                  ...
                  {(data.roleLogin === "ADMIN" ||
                    data.roleLogin === "TEACHER") && (
                    <div className="space-y-4">
                      <div className="mt-6">
