...
export const columns: ColumnDef<StudentWithClass>[] = [
  ...
  },
  {
    ...
    header: () => <div className="truncate">Username</div>,
    cell: ({ row }) => (
  ...
  {
    accessorKey: "phone",
    header: () => <div className="truncate">Telepon</div>,
    enableHiding: true,
  ...
  },
  {
    ...
    header: () => <div className="truncate">Tanggal Lahir</div>,
    enableHiding: true,
    cell: ({ row }) => (
      <div className="truncate">
        {dayjs(row.original.birthday).format("DD MMMM YYYY")}
      </div>
    ),
  },
  {
  ...
  {
    accessorKey: "address",
    header: () => <div className="truncate">Alamat</div>,
    enableHiding: true,
    cell: ({ row }) => (
        ...
        <DropdownMenuContent align="end">
          ...
          {row.original.roleLogin === "ADMIN" && (
            <>
              <DropdownMenuItem>
                <Link
                  href={`/list/students/${row.original.id}/edit`}
                  className="flex flex-row items-center gap-2 w-full"
                >
        ...
        <form onSubmit={handleSubmit}>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="mb-1">
              Tindakan ini tidak dapat dibatalkan. Ini akan menghapus akun siswa
              secara permanen dan menghapus data siswa dari server kami.
            </AlertDialogDescription>
          </AlertDialogHeader>
