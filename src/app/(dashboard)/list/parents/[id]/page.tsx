                    ...
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col md:flex-row items-center gap-4">
                            <Avatar className="h-24 w-24">
                                <AvatarImage src={parent.img ? `../../uploads/${parent.img}` : "/avatar.png"} />
                                <AvatarFallback>
                                    {parent.first_name?.slice(0, 1)}{parent.last_name?.slice(0, 1)}
                                </AvatarFallback>
                            </Avatar>
                            <div>
                                <h2 className="text-2xl font-semibold">{parent.first_name} {parent.last_name}</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-3">
                            ...
                            <div>
                                ...
                                <p className="font-medium">{dayjs(parent.birthday).format("DD MMMM YYYY")}</p>
                            </div>
                            <div>
                                <p className="text-gray-500 text-sm mb-1">Jenis Kelamin</p>
                                <p className="font-medium">{parent.sex === "MALE" ? "Laki-laki" : "Perempuan"}</p>
                            </div>
                            <div>
                            ...
                            {parent.students.map((student) => (
                                <div key={student.id} className="flex items-center justify-between p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                                    <div className="flex items-center gap-3">
                                        <Avatar>
                                            <AvatarImage src={student.img ? `../../uploads/${student.img}` : "/avatar.png"} />
                                            <AvatarFallback>
