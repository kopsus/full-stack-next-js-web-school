...
export const columns: ColumnDef<ParentWithStudent>[] = [
  ...
  {
    accessorKey: "phone",
    header: () => <div className="truncate">No. Telepon</div>,
    enableHiding: true,
    cell: ({ row }) => (
  ...
  {
    id: "students",
    header: () => <div className="truncate">Daftar Anak</div>,
    cell: ({ row }) => (
    ...
    cell: ({ row }) => (
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem>
            <Link
              href={`/list/parents/${row.original.id}/edit`}
              className="flex flex-row items-center gap-2 w-full"
            >
        ...
        <form onSubmit={handleSubmit}>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="mb-1">
              Tindakan ini tidak dapat dibatalkan. Ini akan menghapus akun orang
              tua secara permanen dan menghapus data orang tua dari server kami.
            </AlertDialogDescription>
          </AlertDialogHeader>
