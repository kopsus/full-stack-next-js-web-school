  ...
  const filteredData = React.useMemo(() => {
    return data.filter((row: any) => {
      ...
      const matchesBloodType =
        bloodType === "All" || row.blood_type === bloodType;
        ...
        <div className="flex flex-col gap-2">
          ...
          <Select value={bloodType} onValueChange={setBloodType}>
            ...
            <SelectContent>
              ...
              <SelectItem className="text-xs md:text-sm" value="A">
                A
              </SelectItem>
              <SelectItem className="text-xs md:text-sm" value="B">
                B
              </SelectItem>
              <SelectItem className="text-xs md:text-sm" value="AB">
                AB
              </SelectItem>
              <SelectItem className="text-xs md:text-sm" value="O">
                O
              </SelectItem>
            </SelectContent>
          </Select>
        ...
        <div className="flex flex-col gap-2">
          ...
          <Select value={gender} onValueChange={setGender}>
            ...
            <SelectContent>
              ...
              <SelectItem className="text-xs md:text-sm" value="FEMALE">
                Perempuan
              </SelectItem>
            </SelectContent>
          </Select>
