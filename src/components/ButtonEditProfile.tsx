...
import { ProfileSchema, profileSchema } from "@/lib/formValidationSchemas/profile";
...
export default function ButtonEdit({ data }: { data: ProfileSchema }) {
    ...
    const [previewUrl, setPreviewUrl] = useState<string | null>(data.img ? `/uploads/${data.img}` : null);
    ...
    async function onSubmit(values: ProfileSchema) {
        try {
            ...
            const result = await updateProfile(data.id!, data.role!, submitValues, formData);
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4 text-left">
                                    ...
                                    <div className="grid grid-cols-1 gap-2">
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    <FormLabel className="text-gray-700">Nama Depan</FormLabel>
                                                    <FormControl>
                                                        <Input
                                                            className="border-gray-300 focus:border-blue-500"
                                                            {...field}
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    <FormLabel className="text-gray-700">Nama Belakang</FormLabel>
                                                    <FormControl>
                                                        <Input
                                                            className="border-gray-300 focus:border-blue-500"
                                                            {...field}
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    <FormLabel className="text-gray-700">Jenis Darah</FormLabel>
