...
export default function ButtonEditEvent({ defaultValues, allClasses }: { defaultValues: Event, allClasses: Class[] }) {
    ...
    async function onSubmit(values: EventSchema) {
        const result = await updateEvent(defaultValues.id, values);
        if (result.success) {
            form.reset();
    ...
    return (
        <AlertDialog open={open} onOpenChange={setOpen}>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    <AlertDialogTitle>Edit Acara</AlertDialogTitle>
                    <AlertDialogDescription className="hidden">
                        Isi formulir berikut untuk mengedit acara. Pastikan semua data yang dimasukkan sudah benar.
