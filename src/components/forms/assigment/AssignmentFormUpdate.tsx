...
export default function ButtonEditAssignment({ allLessons, allClasses, allSubjects, assignmentId, defaultValues }: {
    allLessons: Lesson[],
    allClasses: Class[],
    allSubjects: Subject[],
    assignmentId: number,
    ...
    const [selectedClassId, setSelectedClassId] = useState<number | null>(defaultValues.lesson.classId);
    const [selectedSubjectId, setSelectedSubjectId] = useState<number | null>(defaultValues.lesson.subjectId);
    ...
    useEffect(() => {
        ...
        if (defaultValues.lessonId) {
            const defaultLesson = allLessons.find(lesson => lesson.id === defaultValues.lessonId);
            if (defaultLesson && defaultLesson.classId === selectedClassId && defaultLesson.subjectId === selectedSubjectId) {
            ...
            <AlertDialogContent className="max-w-4xl">
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription className="hidden">
                        Edit formulir berikut untuk memperbarui tugas. Pastikan semua data yang dimasukkan sudah benar.
