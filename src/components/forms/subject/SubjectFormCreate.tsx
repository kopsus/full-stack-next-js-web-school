...
export default function ButtonCreateSubject({ teachers }: { teachers: Teacher[] }) {
  ...
  return (
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>Tambah Mata Pelajaran</AlertDialogTitle>
            ...
            <Form {...form}>
              ...
              >
                <div className="space-y-4 text-left">
                  ...
                  <CustomSearchableInputTeacher teachers={teachers} form={form} />
                </div>
