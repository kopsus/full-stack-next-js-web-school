    ...
    try {
        ...
        const teacher = await prisma.teacher.create({
            data: {
                ...
                subjects: {
                    connect: data.subjects ? data.subjects.map((subjectId) => ({ id: Number(subjectId) })) : [],
                },
                classes: {
                    connect: data.classes ? data.classes.map((classId) => ({ id: Number(classId) })) : [],
                },
            }
        })
...
export const deleteTeacher = async (
    ...
    try {
        ...
        if (teacher?.img !== null && teacher?.img !== undefined && teacher?.img !== "") {
